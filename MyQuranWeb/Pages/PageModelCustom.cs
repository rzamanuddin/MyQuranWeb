...
namespace MyQuranWeb.Pages
{
    public class PageModelCustom : PageModel
    {
        ...
        public string FontSizeSetting
        {
            ...
            {
                string fontSize = "h2";
                if (!string.IsNullOrEmpty(Request.Cookies["ukuranTeksSetting"]))
                {
                    var fontSizeSetting = Request.Cookies["ukuranTeksSetting"];
